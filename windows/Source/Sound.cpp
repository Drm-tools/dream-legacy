...
void CSoundIn::PrepareInBuffer(int iBufNum)
{
	/* Set struct entries */
...
void CSoundOut::AddOutBuffer(int iBufNum)
{
	/* Unprepare old wave-header */
...
void CSoundOut::PrepareOutBuffer(int iBufNum)
{
	/* Set Header data */
