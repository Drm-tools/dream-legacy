...
public:
	...
	void Init(int iNewBufferSize, bool bNewBlocking = false, int iChannels=2);
	bool Write(vector<short>& data);
	bool Write(vector<float>& data);
	bool Write(vector<double>& data);

	void Close();
	
protected:
	template<typename T> bool write(vector<T>& data);
